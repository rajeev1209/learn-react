    ...
    useEffect(() => {
        ...
        const fetchUserReviewBook = async () => {
            if (authState && authState.isAuthenticated) {
                ...
                const userReviewBookReseponse = await fetch(url, requestOptions);

                if (!userReviewBookReseponse.ok) {
                    throw new Error("Something went wrong!");
                }

                const userReviewBookReseponseJson = await userReviewBookReseponse.json();

                setIsReviewLeft(userReviewBookReseponseJson);
            }
